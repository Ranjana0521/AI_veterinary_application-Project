...
def dashboard():
    ...
    <body style="background: linear-gradient(135deg, #d4fc79, #96e6a1); text-align:center; font-family: Poppins, sans-serif; padding-top:80px;">
      ...
      <br><br>
      <button onclick="window.location.href='/scan'" style="padding:10px 25px; background:#00b4d8; color:white; border:none; border-radius:8px;">🔍 Scan QR Code</button>
      <br><br>
...
def generate_pdf():
    ...
    story.append(Paragraph(f"<hr/> <b>Animal Health Report — ID: {animal_id}</b>", styles['Title']))
